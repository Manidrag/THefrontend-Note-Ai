...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\MANISH\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.392\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '202ad73971ab594cd23da4B09dDx0JDVQHV1EAA1NSCwBVAAEK', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/MANISH/.vscode/extensions/wallabyjs.console-ninja-1.0.392/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '202ad73971ab594cd23da4B09dDx0JDVQHV1EAA1NSCwBVAAEK', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

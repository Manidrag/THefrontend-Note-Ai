...
export function Sidebar({ showFavourites, setShowFavourites,newdata }) {
  return (
    <>
      ...
      <div className="md:hidden flex items-center justify-center h-16 bg-white/30 backdrop-blur-2xl p-6 rounded-2xl shadow-2xl w-full   border border-white/20 text-white transition-transform transform  hover:scale-105  overflow-y-auto">
      ...
      <motion.aside
        ...
        className="fixed top-0 left-0 h-screen w-64 bg-gradient-to-br bg-white/30 backdrop-blur-2xl p-6 rounded-2xl shadow-2xl   border border-white/20 text-white transition-transform transform scale-100 hover:scale-105  overflow-y-auto z-20 md:relative md:h-auto md:block hidden"
      >
        {/* Logo and Brand */}
